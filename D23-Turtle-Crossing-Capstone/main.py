...
while game_is_on:
    ...
    # our little turtle). Hint: generate a new car only every 6th time the game loop runs. If you get stuck,
    ...
    # successful crossing, the level should increase. When the turtle hits a car, GAME OVER should be displayed in
    # the centre. If you get stuck, check the video walkthrough in Step 7.
